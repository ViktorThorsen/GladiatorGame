...
public class ReplayCharacterData : MonoBehaviour
{
    public static ReplayCharacterData Instance { get; private set; }
    ...
    {
        var dto = ReplayManager.Instance.selectedReplay.player.character;

...
public class ReplayEnemyPlayerMovement : MonoBehaviour
{
    private ReplayGameManager gameManager;
    private Animator anim;
    private GameObject player;
    private ReplayEnemyInventoryBattleHandler playerInventoryBattleHandler;
    ...
    private void RollForDestroyWeapon(int attackIndex)
    {
        ...
        var actionsThisTurn = replay.actions
            .Where(a => a.Turn == currentTurn && a.Actor == CharacterType.EnemyGlad)
            .ToList();
